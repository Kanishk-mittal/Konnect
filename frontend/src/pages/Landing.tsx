      ...
      <div className={styles.bg}>
        <div className={styles.top}>
          ...
          <div className={styles["top-glass"]}>
            <Title style="text-6xl font-bold" />
            <div className="kaushan-script-regular text-2xl w-1/3 text-center">
              A single platform for every announcement, event, and conversation that matters.
            </div>
            <img className="w-[13vw]" src={gatekeeper} />
            <div className="buttons flex gap-6">
              <Link to={"#"}>
                <div className="bg-[#3C096C] text-white text-2xl h-14 w-40 flex justify-center items-center rounded-tl-2xl rounded-b-2xl">
                  Club
                </div>
              </Link>
              <Link to={"#"}>
                <div className="bg-[#8f4cc9] text-white text-2xl h-14 w-40 flex justify-center items-center rounded-b-2xl">
                  Admin
                </div>
              </Link>
              <Link to={"#"}>
                <div className="bg-[#FF7900] text-white text-2xl h-14 w-40 flex justify-center items-center rounded-tr-2xl rounded-b-2xl">
                  Student
                </div>
              </Link>
            </div>
        ...
        <div className={styles.bottom}>
          ...
          <div className='flex flex-col items-center w-full'>
            <div className='flex justify-between w-[90%] mx-auto'>
              <div className={`flex flex-col justify-center w-[40%] gap-2 text-left`}>
                <span className='text-4xl font-extrabold italic mb-3 text-white'>
                ...
                <img className='w-[30%] h-[20vh] object-contain' src={door} />
            </div>
          </div>
          {/* this div is just to provide a gap i know this is not a good practice but this is the easiest fix */}
          <div className="h-10" ></div>
          <Link to={"#"} className="mx-28 text-center flex justify-center items-center">
            <div className="bg-[#FF7900] text-white font-bold text-xl py-3 px-8 rounded-lg shadow-lg w-60 h-14 flex justify-center items-center">
              Register
            </div>
          </Link>
          {/* same here*/}
